...
【搜索说明】
- 支持模糊匹配：简写、拼音首字母、英文名、中文名等多种形式
- 例如："陈恩红" 可能对应 "Chen Enhong"、"EH Chen"、"陈恩宏" 等
- 例如："USTC" 可能对应 "中国科学技术大学"、"中科大"、"University of Science and Technology of China" 等

【任务】
1. 在学校官网教师名录中查找（尝试多种名称变体）
2. 在学术数据库中搜索该导师的论文
3. 在知乎、小红书等平台搜索学生经验贴
4. 确认该导师的基本身份（职称、院系）
...
【搜索说明】
- 支持模糊匹配：尝试导师姓名的多种形式（中文名、英文名、拼音、简写等）
- 支持学校简称：如 USTC、中科大、清华、北大等
